        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="{{ route('home') }}">
                <img src="storage/img/logo1.png" href="" width="200">
              </a>
            </div>
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button class="btn btn-success btn-lg" type="submit">{{ __('Registrar') }}</button>
                  </div>
                </div>
                <div class="col-12">
                  <p class="m-0 text-sumir text-center">¿Tener una cuenta? <a href="{{ route('login') }}" class="link-primary text-decoration-none">Iniciar sesión</a></p>
                </div>
              </div>
            </form>
          </div>
